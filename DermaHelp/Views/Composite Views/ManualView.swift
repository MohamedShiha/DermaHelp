...
class ManualView: UIView, LayoutController {
    ...
    private lazy var manualLabel = Label(text: "DermaHelp analyses your captured images in a highly intelligent way to provide the most accurate results, raises your awareness, and shows you the nearest dermatologist on the map.", font: .roundedSystemFont(ofSize: 17), numberOfLines: 0)
    ...
    func setupLayout() {
        ...
        manualLabel.edgesToSuperView(including: [.bottom, .right], insets: .bottom(16) + .right(16))
    }
}
